    ...
    <div>
      ...
      <section className="section has-background-grey-1">
        <div className="container">
          <div className="columns">
            <div className="column is-10 is-offset-1">
              <div className="is-size-2-5 has-text-centered">方案架构</div>
  ...
  <div>
    ...
    <section className="section">
      <div className="container">
        <div className="columns">
          <div className="column is-10 is-offset-1">
            <div className="is-size-2-5 has-text-centered">数据池</div>
            <div className="columns is-multiline">
              {datapool.map((o,i) => (
                <div className="column is-4" key={i}>
                  ...
                  <div className="is-size-6 has-text-centered">{o.head}</div>
                  <div className="is-size-6-5">{o.content}</div>
                </div>
              ))}
            </div>
          </div>
